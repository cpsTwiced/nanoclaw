...
When running in auto mode, ask for permission before making any code changes. Auto mode is not a license to edit files unprompted — propose the change first and wait for explicit approval.
